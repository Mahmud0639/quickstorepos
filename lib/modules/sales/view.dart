...
class SalesView extends GetView<SalesController> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      leading: IconButton(
        onPressed: () => Get.find<MainNavigationController>().changePage(0),
        icon: Icon(
      ...
      actions: [
        IconButton(
          onPressed: () => Get.toNamed(AppRoutes.SALES_HISTORY),
  ...
  void _showConfirmationDialog() {
    Get.defaultDialog(
      ...
      content: Column(
        children: [
          Text(
            "আপনি কি এই ${controller.totalItemsCount}টি পণ্য বিক্রি করতে চান?",
          ),
          SizedBox(height: 10.h),
          Text(
            "মোট বিল: ৳${controller.totalAmount.toStringAsFixed(0)}",
            style: TextStyle(
              fontSize: 20.sp,
              fontWeight: FontWeight.bold,
              color: Colors.deepPurple,
